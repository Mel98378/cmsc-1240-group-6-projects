...
// general data -> enum Game_State (player header)
bool game_over = false;
bool defeated_dragon = false;

// player data -> structs Player and Party (player header)
...
// class data -> split between enum role (player header) and constants
/* 
    attack information:
    -------------------
...
// character creation function prototypes -> ui, player headers
...
// wait until any key pressed -> ui header
void wait_until_key();

// game mechanics prototypes -> areas header
void start_game();
void town();
void mineshaft();
void castle();

// winn and loss prototypes -> ui header
void win_screen();
void lose_screen();

// Combat prototypes -> split between ui and battle header
void battle();
void dragon_battle();
